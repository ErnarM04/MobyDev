...
function Idk() {
  return (
    <div className="flex flex-col gap-17 my-30 mx-40">
      <div className="w-160 flex flex-col gap-5">
        <p className="text-[#1f1f1f] text-[42px] leading-tight">
      ...
      <div className="flex flex-row gap-16 w-fit">
